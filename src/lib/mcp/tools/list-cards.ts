...
export default defineTool({
  name: "list_cards",
  title: "Elenca carte",
  description: "Elenca le carte in galleria dell'utente, con filtri opzionali per nome, rarità, stagione, ruolo e competizione.",
  inputSchema: {
    ...
    includeSold: z.boolean().optional().describe("Includi anche le carte già vendute (default false)."),
